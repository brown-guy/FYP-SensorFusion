...
for a in range(5,99):
        ...
        left_image = cv2.imread(rf"D:\MTS\Datasets\2011_09_28_drive_0070_sync\image_02\data\{a}.png", cv2.IMREAD_GRAYSCALE)
        right_image = cv2.imread(rf"D:\MTS\Datasets\2011_09_28_drive_0070_sync\image_03\data\{a}.png", cv2.IMREAD_GRAYSCALE)
        truth = rd.depth_read(rf"D:\MTS\Datasets\2011_09_28_drive_0070_sync\image_02\ground truth stereo\{a}.png") # function for reading depth  ground truth depth map
        ...
        while True:
            if cv2.getWindowProperty("disp", cv2.WND_PROP_VISIBLE) >= 0:
                ...
                focal_length = 707.049 # in pixels
            ...
            if cv2.waitKey(1) == 27:
                ...
                cv2.imwrite(rf"D:\MTS\Datasets\2011_09_28_drive_0070_sync\image_02\depth maps generated\{a}.png ",depth_uint16)
                break
