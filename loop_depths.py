...
left_image = cv2.imread(r"D:\MTS\Datasets\2011_09_26_drive_0011_sync\image_02\data\0000000005.png", cv2.IMREAD_GRAYSCALE)
right_image = cv2.imread(r"D:\MTS\Datasets\2011_09_26_drive_0011_sync\image_03\data\0000000005.png", cv2.IMREAD_GRAYSCALE)
truth = rd.depth_read(r"D:\MTS\Datasets\2011_09_26_drive_0011_sync\image_02\ground truth stereo\image_02\0000000005.png") # function for reading depth  ground truth depth map
...
while True:
    if cv2.getWindowProperty("disp", cv2.WND_PROP_VISIBLE) >= 0:
        ...
        #stereo3=cv2.StereoSGBM_create(minDisparity=minDisparity, numDisparities=numDisparities, blockSize=blockSize, P1=8*3*blockSize**2, P2=32*3*blockSize**2, disp12MaxDiff=disp12MaxDiff, uniquenessRatio=uniquenessRatio, speckleWindowSize=speckleWindowSize, speckleRange=speckleRange, preFilterCap=preFilterCap,  mode=cv2.STEREO_SGBM_MODE_SGBM_3WAY)
        stereo3=cv2.StereoSGBM_create(minDisparity=1, numDisparities=64, blockSize=11, P1=8*3*11**2, P2=32*3*11**2, disp12MaxDiff=5, uniquenessRatio=15, speckleWindowSize=6, speckleRange=0, preFilterCap=0,  mode=cv2.STEREO_SGBM_MODE_SGBM_3WAY)
    ...
    if cv2.waitKey(1) == 27:
        ...
        cv2.imwrite(r"D:\MTS\Datasets\2011_09_26_drive_0011_sync\image_02\depth maps generated\0000000005.png ",depth_uint16)
        break
